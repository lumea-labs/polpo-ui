  ...
  return (
    ...
    >
      <div className="px-3 py-2 flex-1">
        <p className="text-sm font-medium mb-2">Ask Polpo</p>
      ...
      <Presence present={open}>
        <div
          className={cn(
            ...
            'fixed top-14 right-0 h-[calc(100dvh-3.5rem)] border-s shadow-xl',
            open
    ...
    >
      {messages.length === 0 ? (
        <div className="text-sm text-fd-muted-foreground/80 size-full flex flex-col items-center justify-center text-center gap-2">
          ...
          <p onClick={(e) => e.stopPropagation()}>Ask anything about Polpo UI components.</p>
        </div>
      ) : (
