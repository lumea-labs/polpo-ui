          ...
          <section key={ex.name}>
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-sm text-fd-muted-foreground mt-1">{ex.description}</p>
              </div>
            ...
            <div className="mb-3 flex items-center gap-3 rounded-lg border border-fd-border bg-fd-card px-4 py-2.5 w-fit">
              <code className="font-mono text-xs text-fd-primary">{ex.command}</code>
            </div>

            <Preview path={ex.name} className="p-0 min-h-[500px]" />
          </section>
        ))}
      </div>
    </div>
